	...
	public void onClick(View v) {
		...
		// setup switch case for buttons
				...
				case R.id.greenlanternBttn:
					Intent greenIntent = new Intent(this, com.cm.abouthero.GreenLanternActivity.class);
